...
commentsRouter.get("/comments", CommentContr.GetComment);
commentsRouter.post("/comments", tokenCheckMiddleware, CommentContr.AddComment);
commentsRouter.put("/comments/:id", tokenCheckMiddleware, CommentContr.PutComment);
commentsRouter.delete("/comments/:id", tokenCheckMiddleware, CommentContr.DeleteComment);
